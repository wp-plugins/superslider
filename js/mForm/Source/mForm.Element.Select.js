...
mForm.Element.Select = new Class({
	...
	options: {
		...
		search: 30,						// this many options are neccessary to show the search option (set to true or 0 to always show the search textfield)
		...
		autoPosition: false,				// adjusts position if there is not enough space in window to show all options
